...
import { BASE_URL } from "../services/api"; // ✅ Only change added
...
function Payment() {
    ...
    const placeOrder = async () => {
        ...
        let userFromBackend;
        try {
            const res = await fetch(`${BASE_URL}/users/${currentUser.id}`); // ✅ updated
        ...
        try {
            await fetch(`${BASE_URL}/users/${currentUser.id}`, { // ✅ updated
                method: "PUT",
